              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-4">
                  <button
                    ...
                    className=" w-full bg-green-500 text-white rounded-md py-2 px-4 focus:outline-none focus:ring focus:ring-green-400 hover:bg-green-600 transition duration-300 ease-in-out"
                  >
                    Add Task
                  </button>
                </div>
